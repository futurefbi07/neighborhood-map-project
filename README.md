...
The page should automatically load in browser via http://localhost:3000.<br> But, the App will not display until you edit the App.js file and enter your Client ID, Client Secret, and API Key where indicated.
